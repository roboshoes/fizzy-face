package com.roboshoes.shared;

import com.roboshoes.shared.font.BlockLetter;
...
public class BubbleController {
    ...
    public int getAmount() { return BUBBLE_COUNT; }
...
//            positions[ i + 2 ] = 0.0f;
            ...
            positions[ i ]     = -1.0f + xy[ 0 ] * 2.0f;
            positions[ i + 1 ] = -1.0f + xy[ 1 ] * 2.0f;
            positions[ i + 2 ] = 0.0f;
        }
