package com.roboshoes.shared.motion;

import com.roboshoes.shared.math.Bezier;
import com.roboshoes.shared.math.MathUtils;
...
public class Motion {
    ...
    private float[] getRandomPoint() {
        float[] point = MathUtils.polarToCartesian( (float) Math.random() * MathUtils.TAU, radius );
